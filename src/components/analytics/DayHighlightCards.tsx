  ...
  return (
    <div className="grid grid-cols-2 gap-2.5 md:gap-3">
      <Card className="min-w-0 !p-3.5">
        ...
        {highest ? (
          <>
            <FitText className="mt-1 text-base font-semibold tabular-nums">{formatCurrency(highest.total)}</FitText>
      ...
      <Card className="min-w-0 !p-3.5">
        ...
        {lowest ? (
          <>
            <FitText className="mt-1 text-base font-semibold tabular-nums">{formatCurrency(lowest.total)}</FitText>
            <p className="text-xs text-neutral-400 dark:text-neutral-500">
